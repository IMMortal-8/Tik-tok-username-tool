...
made_by_thomas = "Edit by thomas_skid And Immortal"

Tik_tok = "Tik_tok username changer " 

print(colored(secure_tools, 'cyan'))
print(colored(Tik_tok, 'green'))
print(colored(made_by_thomas, 'yellow'))
...
def main():
    ...
    session_id = input(colored("Enter the sessionid : ", 'red'))
